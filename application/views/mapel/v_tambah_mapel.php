            ...
            <form class="form-horizontal" id="form-tambah">
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="idmapel" class="form-control inputIDmapel" placeholder="ID Mapel"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="namamapel" class="form-control inputNamamapel"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name="kkmmapel" class="form-control inputKkmmapel"
